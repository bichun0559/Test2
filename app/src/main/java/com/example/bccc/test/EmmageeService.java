...
import com.example.bccc.test.utils.Constants;
import com.example.bccc.test.utils.CpuInfo;
import com.example.bccc.test.utils.CurrentInfo;
import com.example.bccc.test.utils.EncryptData;
import com.example.bccc.test.utils.FpsInfo;
import com.example.bccc.test.utils.MemoryInfo;
import com.example.bccc.test.utils.MyApplication;
import com.example.bccc.test.utils.ProcessInfo;
import com.example.bccc.test.utils.Programe;
import com.example.bccc.test.utils.Settings;
...
public class EmmageeService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		PendingIntent contentIntent = PendingIntent.getActivity(
				getBaseContext(), 0, new Intent(this, MainActivity.class),
				0);
